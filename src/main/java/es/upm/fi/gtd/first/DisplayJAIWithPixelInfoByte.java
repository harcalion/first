...
/**
 * Clase hija de DisplayJAIWithPixelInfo que implementa un array de bytes como
 * almacenamiento de los datos de imagen
 * @author Alvar
 */
public class DisplayJAIWithPixelInfoByte extends DisplayJAIWithPixelInfo implements MouseListener,ActionListener
  {
    /**
  ...
  */
  public DisplayJAIWithPixelInfoByte(GeoImg image, JTextField field,
    ...
    if (isDoubleType) 
    	...
    	Raster ras = image.getImage().getData();
    	ipixel_o = new byte[width*height*ipixel.length];
 ...
 */
  ...
  @Deprecated
    ...
    /**
     * Devuelve la imagen original (en este caso igual a la que se muestra)
     * @return Imagen original
     */
    @Override
        public RenderedImage getSource()
        {
            return super.surrogateImage;
        }
