...
/**
 * Clase hija de DisplayJAIWithPixelInfo que implementa un array de float como
 * almacenamiento de los datos de imagen
 * @author Alvar
 */
public class DisplayJAIWithPixelInfoFloat extends DisplayJAIWithPixelInfo implements MouseListener,ActionListener
{
    /**
...
//protected PlanarImage surrogateImage;
  ...
  */
	public DisplayJAIWithPixelInfoFloat(GeoImg image, JTextField field,
...
private void guardar() {
		...
		{		
			...
			{// Guardar como TIFF
				...
				TiledImage tiled = ElegirProfundidad.crearProfundidadReducida(dpixel_o, profundidad, this.source.getWidth(), this.source.getHeight());
