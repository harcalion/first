...
/**
 * Clase hija de DisplayJAIWithPixelInfo que implementa un array de int como
 * almacenamiento de los datos de imagen
 * @author Alvar
 */
public class DisplayJAIWithPixelInfoInt extends DisplayJAIWithPixelInfo implements MouseListener,ActionListener
  {
    /**
  ...
  */
  public DisplayJAIWithPixelInfoInt(GeoImg image, JTextField field,
    ...
    streamData = image.getStreamMetadata();
 ...
 */
  ...
  private void guardar() {
		...
		{		
			...
			// Importantísimo para quitarme de líos
			if (guardar.exists())
			{ // Si acaso, avisar
				guardar.delete();
			...
			{// Guardar como TIFF
				...
				TiledImage tiled = null;
			 		...
			 		// 	Preparar los metadatos (poner a 32 bits y escribir)
			 		GeoTiffIIOMetadataAdapter ti = new GeoTiffIIOMetadataAdapter (imageData);
   ...
   /**
     ...
     * @return Un int[] con los valores de pixel
     */
