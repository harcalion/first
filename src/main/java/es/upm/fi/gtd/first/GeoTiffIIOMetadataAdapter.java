...
public class GeoTiffIIOMetadataAdapter
{
    ...
    /**
     * Eslabón (100 eslabones = 1 cadena)
     */
    ...
    /**
     * Grado-Minuto-Segundo semiesférico
     */
    ...
    /**
     * Geographic Coordinate System - World Geodetic System 1972
     */
    public static final int GCS_WGS_72 = 4322;
    /**
     * Geographic Coordinate System - World Geodetic System 1972 BE
     */
    ...
    /**
     * Geographic Coordinate System Ellipsoidal - World Geodetic System 1984
     */
    ...
    /**
     * Projected Coordinate System - World Geodetic System 1972 - Universal Traverse
     * Mercator
     */
    ...
    /**
     * Projected Coordinate System - World Geodetic System 1984 - Universal Traverse
     * Mercator
     */
    ...
    public class GeoKeyRecord
    {
        ...
        /**
         * Constructor
         * @param keyID Identificador GeoTIFF de clave
         * @param tagLoc Localización de la etiqueta (si vale 0, el valor está
         * contenido en la propia etiqueta)
         * @param count Número de valores contenidos en la clave
         * @param offset Desplazamiento del primer valor con respecto a la clave
         */
        ...
        /**
         * Obtiene el valor de la clave de identificación GeoTIFF
         * @return Valor del identificador
         */
        public int getKeyID() { return myKeyID; }
        /**
         * Obtiene la localización de la etiqueta
         * @return Localización de la etiqueta
         */
        ...
        /**
         * Obtiene el desplazamiento del primer valor
         * @return Desplazamiento del primer valor
         */
     ...
     * root IIOMetadataNode.
     *
     * @param f Archivo a partir del cual crear los metadatos
     */
    public GeoTiffIIOMetadataAdapter(File f)
    {
    	...
    	try
    	{
//  		read a tiff source image file

    		s = new FileSeekableStream(f);

    		Iterator it =
    			javax.imageio.ImageIO.getImageReadersBySuffix("tif");
    		javax.imageio.ImageReader imgReader = null;
    		if (it.hasNext())
    		{
    			imgReader = (javax.imageio.ImageReader)it.next();
    		}
    		else
    		{
    			throw new Exception("Image IO tif reader not found");
    		}

    		imgReader.setInput(new MemoryCacheImageInputStream(s),
    				false);
    		//int pageCount = imgReader.getNumImages( true);
    		int minIndex = imgReader.getMinIndex();
    		//System.out.println(" Number of images in this image = " +
       		//		pageCount + " , minIndex = " + minIndex);
    		BufferedImage imagePage = imgReader.read( minIndex);
    		System.out.println(" Image loaded!");
    		IIOMetadata metaData = imgReader.getImageMetadata(
    				minIndex);
    		imageMetadata = metaData;
    		streamMetadata = imgReader.getStreamMetadata();
    		img = new IIOImage(imagePage, null, metaData);
    		String formatName = img.getMetadata().getNativeMetadataFormatName();
    		myRootNode = (IIOMetadataNode)img.getMetadata().getAsTree(formatName);
    	}
    	catch (Exception e)
    	{
     ...
     * format.
     * @return Versión del directorio de GeoKey
     */
     ...
     * @return Número de revisión de las GeoKeys de los metadatos
     */
     ...
     * @return Número menor de revisión de las GeoKeys de los metadatos
     */
     ...
     * @return Número de GeoKeys en el directorio
     */
     ...
     * @param node
     * @return Valor de atributo entero
     */
    ...
    /**
     * Devuelve el nodo raíz del árbol de metadatos
     * @return Nodo raíz
     */
    ...
    /**
	 * Busca el nodo y cambia su valor (utilizando la función getTiffField)
	 * 
	 * @param tag Etiqueta
	 * @param valor Valor nuevo de la etiqueta
	 */
    
    public void setTiffField(int tag, String valor)
    {
    	IIOMetadataNode nodoresultado = getTiffField(tag);
    	nodoresultado.setAttribute("value", valor);
    	
    }
    
    /**
     * Establece el valor double de la etiqueta
     * @param tag Etiqueta
     * @param valor Valor double nuevo de la etiqueta
     */
    public void setTiffDoubles(int tag, double[] valor)
    {
        IIOMetadataNode nodoresultado = getTiffField(tag);
        IIOMetadataNode doublesElement = 
            (IIOMetadataNode)nodoresultado.getFirstChild();
        NodeList doubles = doublesElement.getElementsByTagName(TIFF_DOUBLE_TAG);
        
        if (doubles == null)
        {
            System.out.println("Doubles es null");
        }
        
        for(int i=0; i<doubles.getLength(); i++)
        {
            IIOMetadataNode node = (IIOMetadataNode) doubles.item(i);
            System.out.println("El valor del nodo es: "+node.getNodeValue());
            System.out.println("El nombre del nodo es: "+node.getNodeName());
            System.out.println("El valor del atributo value del nodo es: "+getValueAttribute(node));
            
            node.setAttribute("value", String.valueOf(valor[i]));
            
            System.out.println("El valor del atributo value del nodo tras la modificación es: "+getValueAttribute(node));
     ...
     * @return Array de enteros contenidos en el campo
     */
     ...
     * @return Array de doubles contenidos en el campo
     */
     ...
     * @param tiffField An IIOMetadataNode pointing to a TIFFField
     * element that contains a TIFFDoubles element.
     * @param index Índice del valor deseado dentro del array de double
     * @return Valor en la posición del índice
     */
     ...
     * @return Array de double contenido en el campo
     */
     ...
     * @param index The 0-based index of the desired short value
     * @return Valor double en la posición del índice
     */
     ...
     * @param start Inicio de la porción de string
     * @param length Longitud de la porción de string
