...
public class ImageInfo {
	...
	/** Return value of {@link #getFormat()} for TIFF streams. */
	public static final int FORMAT_TIFF = 11;
...
/*	public static final int COLOR_TYPE_UNKNOWN = -1;
	...
	public boolean check() {
		...
		try {
			...
			if (b1 == 0x38 && b2 == 0x42) {
				...
				int b3 = read() & 0xff; //TIFF Magic Number
				int b4 = read() & 0xff;
				if ((b1 == 0x49 && b2 == 0x49 && b3 == 0x2a) || (b1 == 0x4d && b2 == 0x4d && b4 == 0x2a))
				{ // Es un TIFF, magic number = 42
					format = FORMAT_TIFF;
     ...
     * @return Devuelve el comentario en la posición del índice
