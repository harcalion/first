/*
 * DialogoFusionPCA.java
 *
 * Created on 3 de mayo de 2008, 18:10
 */
...
import es.upm.fi.gtd.ij.Fusion_por_PCAMod;
import ij.ImagePlus;
 ...
 * @author  Alvar
 */
public class DialogoFusionPCA extends javax.swing.JDialog {
...
boolean multi = false;
File file_pan;
/** Creates new form DialogoFusionPCA
 ...
 */
    ...
    public DialogoFusionPCA(java.awt.Frame parent, boolean modal, Atrous princ) {
        super(parent, modal);
        principal = princ;
        ic = principal.getIC();
        initComponents();
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Reescalar Visualización");
...
private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        boolean reescalar = jCheckBox1.isSelected();
        ...
        Fusion_por_PCAMod fpp = new Fusion_por_PCAMod (nbits,reescalar, interpolar,ip_multi,ip_pan);
        ImageProcessor [] resultado = fpp.PCA(fpp.multibanda,fpp.pancromatica);
        ImagePlus [] res = fpp.postPCA(resultado);
        for (int i = 0; i < 3; i++)
        {
            
           
           //Image ima = res[i].getImage().getScaledInstance(-1, -1, Image.SCALE_DEFAULT);
           PlanarImage pi = FusionAux.transformarDesdeImagePlus(res[i], pan.get(0).getImage());
           ...
           System.out.println(pi.getColorModel().toString());
            melt.add(
                new GeoImg(null, 
                            pi, 
                            new File ("Fusión PCA de "+file_pan.getName()), 
                            null, 
                            null));
        }
...
/**
 * Transforma una imagen básica de AWT en una imagen de acceso directo (Buffered
 * Image)
 * @param image Imagen de entrada
 * @param newModelId Modelo de datos buffered
