...
/**
 * An implementation of {@link IntChannelImage} that stores image channels as
 ...
 * @since 0.11.0
 */
public abstract class MemoryIntChannelImage implements IntChannelImage
{
	 ...
	 */
	public MemoryIntChannelImage(int numChannels, int width, int height)
	{
		if (width < 1)
		{
	...
	public PixelImage createCopy()
	{
		...
		MemoryIntChannelImage result = (MemoryIntChannelImage)copy;
