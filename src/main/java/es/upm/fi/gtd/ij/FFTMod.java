...
*/
public class FFTMod implements  PlugIn, Measurements {
	...
	private boolean doFFT;
        ...
        public ImagePlus doForward (ImagePlus imp)
        {
            this.imp = imp;
            ImageProcessor ip = imp.getProcessor();
            Object obj = imp.getProperty("FHT");
	    FHT fht = fht = newFHT(ip);
            stackSize = imp.getStackSize();
            fileName = imp.getTitle();
	    return doForewardTransformMod(fht);
	...
	void doInverseTransform(FHT fht) {
        ...
        ImagePlus doForewardTransformMod(FHT fht) {
