 ...
 *
 */
public class Fusion_BroveyMod implements PlugInFilter {
    ...
    public Fusion_BroveyMod (int nbits, boolean interpolar, ImageProcessor [] multi_original, ImageProcessor pan)
    {
                this.nbits = nbits;
