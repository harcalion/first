 ...
 **/
public class Fusion_mediante_MDMR implements PlugInFilter {
     ...
     */
    public void MDMR(ImageProcessor[] multi, ImageProcessor pan, int multiLev, int panLev, double[] a, double[] b) {
