...
package es.upm.fi.gtd.pdfviewer;
...
private static final long serialVersionUID = 1L;
    public final static String          TITLE = "Manual de FIRST";
...
private static final long serialVersionUID = 1L;
    ...
    Action printAction = new AbstractAction("Print...", getIcon("/resources/print.gif")) {
private static final long serialVersionUID = 1L;
        public void actionPerformed(ActionEvent evt) {
            doPrint();
        }
...
private static final long serialVersionUID = 1L;
    ...
    ZoomAction zoomInAction = new ZoomAction("Zoom in",
            getIcon("/resources/zoomin.gif"),
            2.0);
    ZoomAction zoomOutAction = new ZoomAction("Zoom out",
            getIcon("/resources/zoomout.gif"),
            0.5);
    Action zoomToolAction = new AbstractAction("", getIcon("/resources/zoom.gif")) {
private static final long serialVersionUID = 1L;
        public void actionPerformed(ActionEvent evt) {
            doZoomTool();
        }
...
private static final long serialVersionUID = 1L;
    ...
    Action fullScreenAction = new AbstractAction("Full screen",
            getIcon("/resources/fullscrn.gif")) {
private static final long serialVersionUID = 1L;
        public void actionPerformed(ActionEvent evt) {
            doFullScreen((evt.getModifiers() & evt.SHIFT_MASK) != 0);
        }
    };
    Action nextAction = new AbstractAction("Next", getIcon("/resources/next.gif")) {
private static final long serialVersionUID = 1L;
        public void actionPerformed(ActionEvent evt) {
            doNext();
        }
    };
    Action firstAction = new AbstractAction("First", getIcon("/resources/first.gif")) {
private static final long serialVersionUID = 1L;
        public void actionPerformed(ActionEvent evt) {
            doFirst();
        }
    };
    Action lastAction = new AbstractAction("Last", getIcon("/resources/last.gif")) {
private static final long serialVersionUID = 1L;
        public void actionPerformed(ActionEvent evt) {
            doLast();
        }
    };
    Action prevAction = new AbstractAction("Prev", getIcon("/resources/prev.gif")) {
private static final long serialVersionUID = 1L;
        public void actionPerformed(ActionEvent evt) {
            doPrev();
        }
